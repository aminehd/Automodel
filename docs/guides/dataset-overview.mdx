...
- See also: [LLM datasets](/datasets/text-dataset), [VLM datasets](/datasets/multi-modal-dataset), [Retrieval dataset](/datasets/retrieval-dataset), and [Retrieval fine-tuning](/recipes-e2e-examples/retrieval-finetune) for deeper, task-specific guides.
...
dataloader:
  ...
  shuffle: true
```
See the detailed guide, [Retrieval dataset](/datasets/retrieval-dataset), for more information. For the end-to-end
